        ...
        if 'print_stats' in status:
            ...
            if 'filename' in ps:
                ...
                if new_filename != self._print_filename and new_filename:
                    ...
                    # 直接使用文件名请求元数据（API 不需要 gcodes/ 前缀）
                    self.requestFileMetadata(new_filename)
