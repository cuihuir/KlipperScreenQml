...
### 3. move - 完整移动控制页 ⭐⭐⭐
**优先级**: 高
**状态**: 部分完成 (MoveControl 组件已有)
**预计工作量**: 1-2 小时

**功能需求**:
- [x] XYZ 轴移动控制 (已有)
- [x] 移动距离选择 (0.1/1/10/50/100mm) (已有)
- [x] 归零按钮 (X/Y/Z/全部) (已有)
- [ ] 速度调节滑块
- [ ] Z 轴探针
- [ ] 禁用电机
...
**功能需求**:
- [ ] 进料/退料按钮
- [ ] 挤出长度选择 (5/10/25/50/100mm)
- [ ] 挤出速度选择 (1-20 mm/s)
- [ ] 温度显示 (当前/目标)
- [ ] 温度不足警告 (< 170°C)
- [ ] 多挤出机支持 (extruder/extruder1)
- [ ] 更换耗材向导
...
- [ ] Z 轴偏移 (-2mm ~ +2mm)
  - [ ] 微调滑块 (0.01mm 步进)
  - [ ] 实时应用 (SET_GCODE_OFFSET Z_ADJUST)
- [ ] 风扇速度覆盖
